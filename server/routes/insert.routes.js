...
module.exports = function (connection, app) {
  app.post("/api/insert", function (req, res) {
    ...
    let command = `${insertPrefix} VALUES ("${specimen.catalogNumber}", "${specimen.otherCatalogNumber}" ,"${specimen.recordNumber}", "${specimen.order_}", "${specimen.superfamily}", "${specimen.family}", "${specimen.subfamily}", "${specimen.tribe}", "${specimen.genus}", "${specimen.subgenus}", "${specimen.specificEpithet}", "${specimen.identificationQualifier}", "${specimen.recordedBy}", "${specimen.identifiedBy}", "${specimen.dateIdentified}", "${specimen.sex}", "${specimen.lifeStage}", "${specimen.habitat}", "${specimen.occurrenceRemarks}", "${specimen.country}", "${specimen.stateProvince}", "${specimen.county}",  "${specimen.municipality}", "${specimen.locality}", "${specimen.elevationInMeters}", "${specimen.decimalLatitude}", "${specimen.decimalLongitude}", "${specimen.geodeticDatum}", "${specimen.coordinateUncertainty}", "${specimen.verbatimLatitude}", "${specimen.verbatimLongitude}", "${specimen.loanInfo}", "${specimen.preparations}", "${specimen.freezer}", "${specimen.rack}", "${specimen.box}", "${specimen.tubeSize}", "${specimen.collectors}", "${specimen.modifiedInfo}");`;
    // console.log(command)
