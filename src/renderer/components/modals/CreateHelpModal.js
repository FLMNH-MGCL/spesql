          ...
          >
            ...
            <Modal.Content>
              ...
              <p style={{ paddingTop: "2rem", paddingBottom: "1rem" }}>
                ...
                to a typical conditional (=, {">"}, etc) this operator initiates
                a{" "}
                <a
              ...
              <p>
                ...
                would not be able to use an operator such as '{">"}='. One
                regular expression you could use to achieve this, however, would
                be as follows:
              </p>
      ...
      case "LIST_HELP":
        ...
        return (
          <Modal
            ...
            centered
            trigger={
              <Button icon basic color="linkedin">
                <Icon name="question" />
              </Button>
            }
          >
