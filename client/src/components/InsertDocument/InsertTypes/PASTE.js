                ...
                if (index === insertData.length - 1) {
                    if (errors.length > 0) {
                        ...
                        this.props.notify({
                            type: "success",
                            message:
                                "Entries successfully submitted without errors"
                        });
                    }
    ...
    handleCSVSubmit = () => {
        ...
        for (var i = 1; i < ret.data.length; i++) {
            ...
            const doc = {
                ...
                loanInfo: specimen[36], // MIGHT POSE ISSUES
                    ...
                    <Grid.Row>
                        <Grid.Column width={16}>
                            <Message>
                                ...
                                <p>
                                    Copy & paste CSV data into this text area.
                                    Be sure to include the proper headers.{" "}
                                    <a
                                        href="../../assets/CORRECT_HEADERS_TEMPLATE.csv"
                                        download
                                    >
                                        Click here
                                    </a>{" "}
                                    to download an example template for the
                                    correct headers.
                                </p>
                            </Message>
                            <Form
