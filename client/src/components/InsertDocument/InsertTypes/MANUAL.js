...
export default class MANUAL extends React.Component {
        ...
        if (errors.length === 0) {
            ...
            if (!insertData.data.success) {
                ...
                this.props.notify({
                    type: "error",
                    message:
                        "Uh oh, an error detected. Please check INSERT error log"
                });
    ...
    render() {
        if (
            !this.state.hasError &&
            this.props.errorMessages.insertError !== null
        ) {
        ...
        return (
            <React.Fragment>
                <Message>
                    ...
                    <p>
                        Manually enter the transcription data of the specimen
                        you are entering into the database. Be sure to fill out
                        all required fields. When all fields are completed,
                        click the Confirm button at the bottom of the
                        scroll-view. If any syntactic errors are present, a
                        popup will appear with information to help you correct
                        it. If you have more than one specimen to enter,
