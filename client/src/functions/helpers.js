export function getQueryHeaders(specimen) {
    ...
    if (
        ...
        if (count < 8 && (specimen.catalogNumber || specimen.catalogNumber === '')) {
            ret.push('MGCL #')
            count += 1
        }
        if (count < 8 && (specimen.recordNumber || specimen.recordNumber === '')) {
            ret.push('LEP #')
            count += 1
        }
        ...
        if (count < 8 && (specimen.specificEpithet || specimen.specificEpithet === '')) {
            ret.push('Species')
            count += 1
        }
        ...
        if (count < 8 && (specimen.stateProvince || specimen.stateProvince === '')) {
            ret.push('Province')
            count += 1
        }
        ...
        if (count < 8 && (specimen.verbatimLatitude || specimen.verbatimLatitude === '')) {
            ret.push('Latitude')
            count += 1
        }
        if (count < 8 && (specimen.verbatimLongitude || specimen.verbatimLongitude === '')) {
            ret.push('Longitude')
            count += 1
        }
        if (count < 8 && (specimen.verbatimElevation || specimen.verbatimElevation === '')) {
            ret.push('Elevation')
            count += 1
        }
